...
const GOOD_VOICES = ['excellent', 'welldone', 'fantastic', 'brilliant', 'remarkable', 'terrific', 'sensational', 'sublime', 'wonderful', 'marvelous', 'firstclass', 'sterling', 'superb', 'delicious'];
