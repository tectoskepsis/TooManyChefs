...
const SOUNDS = ['click1', 'click2', 'click3', 'blender', 'boop', /*'cork',*/ 'cupboard', /*'cutlery1', 'cutlery2',*/ 'frying', /*'grinder',*/ 'mixer', 'pouring', 'sink', 'slice', 'eggcrack', 'eggbeat1', 'eggbeat2', 'microwave', 'phone1', 'phone2', 'phone3', 'money', 'boil'];
